...
window.HOMESTEAD_PLANTS = [
  {
    ...
    "hardiness": "Zone 8b Hardy (PNW)",
    "blooms": "April",
    "harvest": "October",
    "pests": "Amere de Berthcourt can be affected by Apple Scab. Apple Scab is more prevalent in regions with wet springs, like we have in the Pacific Northwest. While it does not seriously affect the quality of the fruit, it can cause black spots on the apples and foliage. Apple Scab can be controlled by sulfur and other sprays. Codling Moth can create wormy apples and aphids can damage the foliage of apple trees.",
    "edibility": "The cornerstone of the homestead orchard. Varieties range from crisp fresh-eating dessert apples to high-tannin vintage cider apples and red-fleshed antioxidant cultivars.",
    "medicinalUse": "Traditional European folk wisdom: 'An apple a day.' Rich in dietary pectin to bind cholesterol, quercetin flavonoids for allergy relief, and organic malic acid for liver health.",
    "recipes": "Homestead Hard Heritage Cider, Spiced Apple-Cider Butter, slow-baked Redlove apple tarts, and dried cinnamon apple rings.",
  ...
  {
    "id": "amish-gooseberry",
    "commonName": "Amish Gooseberry",
    "latinName": "Ribes grossularia",
    "genus": "Ribes",
    ...
    "harvest": "July",
    "pests": "",
    "edibility": "Gooseberries and Clove Currants produce sweet, aromatic berries with a tantalizing clove fragrance or brisk vinous tartness. Eaten fresh, baked into crumbles, or jellied.",
    "medicinalUse": "Traditional European herbalists used gooseberries for fever relief and rheumatic complaints. High in dietary pectin, Vitamin C, and flavonoids.",
    "recipes": "Classic Gooseberry & Elderflower Fool, Spiced Clove Currant Jam, roasted gooseberry glaze for pork, and summer berry tarts.",
  ...
  },
  {
    ...
    "commonName": "Autumn Beauty Jujube Tree",
    ...
    "blooms": "Mid-summer",
    "harvest": "mid-October",
    "pests": "Jujube is not bothered by pests or diseases.",
    "edibility": "The Chinese Red Date. When fresh, the fruit is crisp, sweet, and juicy like a tiny honeyed apple. As it dries, it naturally wrinkles into a chewy, molasses-caramel date with endless shelf life.",
    "medicinalUse": "Cornerstone of Traditional Chinese Medicine (Da Zao). Used as a calming adaptogen to nourish blood, ease anxiety, promote deep sleep, and harmonize harsh herbal formulas.",
    "recipes": "Spiced Homestead Jujube Compote, Candied Red Dates, Jujube-Ginger restorative winter tea, and dried date quick breads.",
  ...
  },
  {
    ...
    "commonName": "Chehalis Apple Tree",
    "latinName": "Malus domestica",
    "genus": "Malus",
    "category": "Fruit & Nut Trees",
    "categoryName": "Fruit & Nut Trees",
    ...
    "pests": "Chehalis is very resistant to Apple Scab. Codling Moth can create wormy apples and aphids can damage the foliage of apple trees.",
    "edibility": "The cornerstone of the homestead orchard. Varieties range from crisp fresh-eating dessert apples to high-tannin vintage cider apples and red-fleshed antioxidant cultivars.",
    "medicinalUse": "Traditional European folk wisdom: 'An apple a day.' Rich in dietary pectin to bind cholesterol, quercetin flavonoids for allergy relief, and organic malic acid for liver health.",
    "recipes": "Homestead Hard Heritage Cider, Spiced Apple-Cider Butter, slow-baked Redlove apple tarts, and dried cinnamon apple rings.",
    "craftAndUtilitarian": "Apple wood is the premier wood for smoking bacon, sausages, and poultry. Pruned winter branches make excellent biochar and natural cooking fuel.",
  ...
  {
    "id": "chilean-hazelnut",
    "commonName": "Chilean Hazelnut",
    "latinName": "Gevuina avellana",
    "genus": "Gevuina",
    "category": "Fruit & Nut Trees",
    "categoryName": "Fruit & Nut Trees",
    ...
    "harvest": "October",
    "pests": "",
    "edibility": "The Chilean Hazelnut (Avellano) produces round, crunchy nuts with an exceptionally rich, buttery, sweet flavor superior to common hazelnuts. Eaten raw or roasted.",
    "medicinalUse": "Nut oil is exceptionally rich in monounsaturated palmitoleic acid and natural sunscreen polyphenols, traditionally used by Mapuche communities for skin repair and UV protection.",
    "recipes": "Roasted Chilean Hazelnuts with homestead sea salt, homemade praline paste, and ground hazelnut flour for autumn baking.",
  ...
  },
  {
    ...
    "commonName": "Chilean Myrtle Berry",
    "latinName": "Luma apiculata, syn. Myrtus luma",
    "genus": "Luma",
    "category": "Berries & Understory",
    "categoryName": "Berries & Understory",
    ...
    "harvest": "November",
    "pests": "",
    "edibility": "Small, glossy, purple-black berries with an aromatic, sweet, spicy flavor reminiscent of cloves and berries. Eaten fresh or made into preserves.",
    "medicinalUse": "Mapuche herbalism uses the leaves as an astringent infusion for sore gums, throat gargles, and digestive stimulation.",
    "recipes": "Chilean Myrtle Berry Spiced Jam, infused artisan vinegars, and Chilean Arrayán liqueur.",
  ...
  },
  {
    ...
    "commonName": "Confetti Jujube Tree",
    "latinName": "Ziziphus jujuba",
    "genus": "Ziziphus",
    "category": "Fruit & Nut Trees",
    "categoryName": "Fruit & Nut Trees",
  ...
  },
  {
    ...
    "pests": "Cortland Apple Tree can be affected by Apple Scab although it is considered resistant. Apple Scab is more prevalent in regions with wet springs, like we have in the Pacific Northwest. While it does not seriously affect the eating quality of the fruit, it can cause black spots on the apples and foliage. Apple Scab can be controlled by sulfur and other sprays. Codling Moth can create wormy apples and aphids can damage the foliage of apple trees.",
    "edibility": "The cornerstone of the homestead orchard. Varieties range from crisp fresh-eating dessert apples to high-tannin vintage cider apples and red-fleshed antioxidant cultivars.",
    "medicinalUse": "Traditional European folk wisdom: 'An apple a day.' Rich in dietary pectin to bind cholesterol, quercetin flavonoids for allergy relief, and organic malic acid for liver health.",
    "recipes": "Homestead Hard Heritage Cider, Spiced Apple-Cider Butter, slow-baked Redlove apple tarts, and dried cinnamon apple rings.",
    "craftAndUtilitarian": "Apple wood is the premier wood for smoking bacon, sausages, and poultry. Pruned winter branches make excellent biochar and natural cooking fuel.",
  ...
  },
  {
    ...
    "commonName": "Criterion Apple Tree",
    "latinName": "Malus domestica",
    "genus": "Malus",
    "category": "Fruit & Nut Trees",
    "categoryName": "Fruit & Nut Trees",
    ...
    "blooms": "April",
    "harvest": "Early August",
    "pests": "Criterion Apple Tree can be affected by Apple Scab although it is considered resistant. Apple Scab is more prevalent in regions with wet springs, like we have in the Pacific Northwest. While it does not seriously affect the eating quality of the fruit, it can cause black spots on the apples and foliage. Apple Scab can be controlled by sulfur and other sprays. Codling Moth can create wormy apples and aphids can damage the foliage of apple trees.",
    "edibility": "The cornerstone of the homestead orchard. Varieties range from crisp fresh-eating dessert apples to high-tannin vintage cider apples and red-fleshed antioxidant cultivars.",
    "medicinalUse": "Traditional European folk wisdom: 'An apple a day.' Rich in dietary pectin to bind cholesterol, quercetin flavonoids for allergy relief, and organic malic acid for liver health.",
    "recipes": "Homestead Hard Heritage Cider, Spiced Apple-Cider Butter, slow-baked Redlove apple tarts, and dried cinnamon apple rings.",
    "craftAndUtilitarian": "Apple wood is the premier wood for smoking bacon, sausages, and poultry. Pruned winter branches make excellent biochar and natural cooking fuel.",
  ...
  },
  {
    ...
    "harvest": "Late July",
    "pests": "",
    "edibility": "Sweet, plump, antioxidant-packed berries. Varieties range from dwarf container types to giant northern highbush, pink rabbiteye, and native evergreen huckleberries.",
    "medicinalUse": "Celebrated for high anthocyanins, pterostilbene, and resveratrol. Clinical studies demonstrate cognitive enhancement, vascular elasticity, and urinary tract health.",
    "recipes": "Homestead Blueberry Skillet Buckle, Wild Huckleberry Tart, Blueberry Balsamic reduction, and dehydrated blueberry trail snacks.",
  ...
  },
  {
    ...
    "commonName": "Empress Gee Jujube Tree",
    "latinName": "Ziziphus jujuba",
    "genus": "Ziziphus",
    "category": "Fruit & Nut Trees",
    "categoryName": "Fruit & Nut Trees",
  ...
  },
  {
    ...
    "commonName": "Enterprise Apple Tree",
    "latinName": "Malus domestica",
    "genus": "Malus",
    "category": "Fruit & Nut Trees",
    "categoryName": "Fruit & Nut Trees",
    ...
    "pests": "Enterprise is very resistant to Apple Scab. Codling Moth can create wormy apples and aphids can damage the foliage of apple trees.",
    "edibility": "The cornerstone of the homestead orchard. Varieties range from crisp fresh-eating dessert apples to high-tannin vintage cider apples and red-fleshed antioxidant cultivars.",
    "medicinalUse": "Traditional European folk wisdom: 'An apple a day.' Rich in dietary pectin to bind cholesterol, quercetin flavonoids for allergy relief, and organic malic acid for liver health.",
    "recipes": "Homestead Hard Heritage Cider, Spiced Apple-Cider Butter, slow-baked Redlove apple tarts, and dried cinnamon apple rings.",
    "craftAndUtilitarian": "Apple wood is the premier wood for smoking bacon, sausages, and poultry. Pruned winter branches make excellent biochar and natural cooking fuel.",
  ...
  },
  {
    ...
    "blooms": "April",
    "harvest": "Early October",
    "pests": "Apples can be affected by Apple Scab. Apple Scab is especially a problem in regions with wet springs, like we have in the Pacific Northwest. While it does not seriously affect the eating quality of the fruit, it can cause black spots on the apples and foliage. Apple Scab can be controlled by sulfur and other sprays. Codling Moth can create wormy apples and aphids can damage the foliage of apple trees.",
    "edibility": "The cornerstone of the homestead orchard. Varieties range from crisp fresh-eating dessert apples to high-tannin vintage cider apples and red-fleshed antioxidant cultivars.",
    "medicinalUse": "Traditional European folk wisdom: 'An apple a day.' Rich in dietary pectin to bind cholesterol, quercetin flavonoids for allergy relief, and organic malic acid for liver health.",
    "recipes": "Homestead Hard Heritage Cider, Spiced Apple-Cider Butter, slow-baked Redlove apple tarts, and dried cinnamon apple rings.",
    "craftAndUtilitarian": "Apple wood is the premier wood for smoking bacon, sausages, and poultry. Pruned winter branches make excellent biochar and natural cooking fuel.",
  ...
  },
  {
    ...
    "pests": "Sea Berry is not bothered by pests or diseases.",
    "edibility": "Vibrant orange berries known as 'holy fruit'. The juice is extraordinarily tart, citrusy, and tropical, containing up to 12x the Vitamin C of oranges, along with rare Omega-7 fatty acids and carotenoids.",
    "medicinalUse": "Documented in ancient Tibetan (Sibu Yidian) and Greek medical texts. Used for cellular regeneration, healing gastric ulcers, cardiovascular elasticity, and burns. Potent topical oil for skin healing.",
    "recipes": "Homestead Sea Berry Curd, sparkling Honey-Sea Berry Shrub, Sea Berry & Apple leather, and winter immune elixir.",
  ...
  },
  {
    ...
    "commonName": "Frosty Blue Whale's Tongue Agave",
    "latinName": "Agave ovatifolia 'Frosty Blue'",
    "genus": "Agave",
    ...
    "harvest": "",
    "pests": "",
    "edibility": "Roasted agave hearts ('piña') were traditionally pit-baked for 48-72 hours by indigenous peoples of the American Southwest and Northern Mexico, yielding a caramelized, molasses-sweet food rich in prebiotic inulin. Sap (aguamiel) can be fermented into pulque.",
    "medicinalUse": "Historically used as an antimicrobial dressing for wounds and burns. The fresh sap contains saponins and fructans with mild antiseptic and soothing qualities; poulticed leaves were used for joint aches.",
    "recipes": "Pit-roasted agave nectar reduction, fermented aguamiel tepache, or infused wild smoked agave glaze for roasted winter squashes.",
  ...
  },
  {
    ...
    "commonName": "Garden Delicious Dwarf Apple Tree",
    "latinName": "Malus domestica",
    "genus": "Malus",
    "category": "Fruit & Nut Trees",
    "categoryName": "Fruit & Nut Trees",
    ...
    "blooms": "April",
    "harvest": "September",
    "pests": "Garden Delicious is resistant to Apple Scab. Codling Moth can create wormy apples and aphids can damage the foliage of apple trees.",
    "edibility": "The cornerstone of the homestead orchard. Varieties range from crisp fresh-eating dessert apples to high-tannin vintage cider apples and red-fleshed antioxidant cultivars.",
    "medicinalUse": "Traditional European folk wisdom: 'An apple a day.' Rich in dietary pectin to bind cholesterol, quercetin flavonoids for allergy relief, and organic malic acid for liver health.",
    "recipes": "Homestead Hard Heritage Cider, Spiced Apple-Cider Butter, slow-baked Redlove apple tarts, and dried cinnamon apple rings.",
    "craftAndUtilitarian": "Apple wood is the premier wood for smoking bacon, sausages, and poultry. Pruned winter branches make excellent biochar and natural cooking fuel.",
  ...
  },
  {
    ...
    "commonName": "GoldRush Apple Tree",
    "latinName": "Malus domestica",
    "genus": "Malus",
    "category": "Fruit & Nut Trees",
    "categoryName": "Fruit & Nut Trees",
    ...
    "blooms": "April",
    "harvest": "October",
    "pests": "GoldRush is very resistant to Apple Scab. Codling Moth can create wormy apples and aphids can damage the foliage of apple trees.",
    "edibility": "The cornerstone of the homestead orchard. Varieties range from crisp fresh-eating dessert apples to high-tannin vintage cider apples and red-fleshed antioxidant cultivars.",
    "medicinalUse": "Traditional European folk wisdom: 'An apple a day.' Rich in dietary pectin to bind cholesterol, quercetin flavonoids for allergy relief, and organic malic acid for liver health.",
    "recipes": "Homestead Hard Heritage Cider, Spiced Apple-Cider Butter, slow-baked Redlove apple tarts, and dried cinnamon apple rings.",
    "craftAndUtilitarian": "Apple wood is the premier wood for smoking bacon, sausages, and poultry. Pruned winter branches make excellent biochar and natural cooking fuel.",
  ...
  },
  {
    ...
    "commonName": "Golden Russet Apple",
    "latinName": "Malus domestica",
    "genus": "Malus",
    "category": "Fruit & Nut Trees",
    "categoryName": "Fruit & Nut Trees",
    ...
    "blooms": "April",
    "harvest": "Sept-Nov",
    "pests": "Golden Russet is scab and powdery mildew resistant.",
    "edibility": "The cornerstone of the homestead orchard. Varieties range from crisp fresh-eating dessert apples to high-tannin vintage cider apples and red-fleshed antioxidant cultivars.",
    "medicinalUse": "Traditional European folk wisdom: 'An apple a day.' Rich in dietary pectin to bind cholesterol, quercetin flavonoids for allergy relief, and organic malic acid for liver health.",
    "recipes": "Homestead Hard Heritage Cider, Spiced Apple-Cider Butter, slow-baked Redlove apple tarts, and dried cinnamon apple rings.",
    "craftAndUtilitarian": "Apple wood is the premier wood for smoking bacon, sausages, and poultry. Pruned winter branches make excellent biochar and natural cooking fuel.",
  ...
  },
  {
    ...
    "blooms": "late spring long blooming",
    "harvest": "",
    "pests": "",
    "edibility": "Leaves have a strong, pungent aromatic flavor used sparingly in Mediterranean herb rubs and olive marinades.",
    "medicinalUse": "Historically called 'ground cypress'. Used in Mediterranean folk herbalism as a vermifuge, digestive tonic, and insect-repelling sachet.",
    "recipes": "Aromatic herb seasoning for cured olives and rustic roasted root vegetables.",
  ...
  },
  {
    ...
    "commonName": "Koroneiki Olive Tree",
    ...
    "harvest": "Oct-Nov",
    "pests": "None",
    "edibility": "Cold-hardy olive cultivars selected for northern climates. Bitter raw fruits are water-cured, lye-cured, or brined with herbs into delicious table olives, or cold-pressed for extra-virgin oil.",
    "medicinalUse": "Olive oil is the foundation of the heart-healthy Mediterranean diet. Olive leaf extract contains oleuropein, a documented natural antiviral, antibacterial, and hypotensive agent.",
    "recipes": "Homestead Rosemary & Garlic Brined Olives, cold-pressed olive oil, and olive tapenade with capers and lemon.",
  ...
  },
  {
    ...
    "blooms": "April",
    "harvest": "mid-september",
    "pests": "Liberty is very resistant to Apple Scab. Codling Moth can create wormy apples and aphids can damage the foliage of apple trees.",
    "edibility": "The cornerstone of the homestead orchard. Varieties range from crisp fresh-eating dessert apples to high-tannin vintage cider apples and red-fleshed antioxidant cultivars.",
    "medicinalUse": "Traditional European folk wisdom: 'An apple a day.' Rich in dietary pectin to bind cholesterol, quercetin flavonoids for allergy relief, and organic malic acid for liver health.",
    "recipes": "Homestead Hard Heritage Cider, Spiced Apple-Cider Butter, slow-baked Redlove apple tarts, and dried cinnamon apple rings.",
    "craftAndUtilitarian": "Apple wood is the premier wood for smoking bacon, sausages, and poultry. Pruned winter branches make excellent biochar and natural cooking fuel.",
  ...
  },
  {
    ...
    "blooms": "",
    "harvest": "",
    "pests": "Pawpaw is not bothered by pests or diseases.",
    "edibility": "North America's largest native edible fruit. The lush, creamy custard flesh tastes like a tropical fusion of banana, mango, vanilla, and pineapple. Best eaten fresh chilled with a spoon.",
    "medicinalUse": "Cherokee, Iroquois, and other Eastern Woodland tribes used pawpaw bark decoctions as an external wash and anthelmintic. The twigs and leaves contain annonaceous acetogenins, which modern pharmacognosy studies for anti-tumor and insecticidal properties.",
    "recipes": "Pawpaw Wildflower Honey Ice Cream, Pawpaw Homestead Custard Tart, pawpaw quick bread, and pawpaw-bourbon preserves.",
  ...
  },
  {
    ...
    "commonName": "Marseilles Black Fig",
    ...
    "blooms": "Flowers are not noticeable as they are inside the fig.",
    "harvest": "Late August-September",
    "pests": "Fig Mosaic Virus is a benign virus that exists in all cultivated fig trees. Yellow spotting of the leaves is a cosmetic symptom that shows more in container culture, but is quickly outgrown once trees are planted in the ground.",
    "edibility": "Rich, luscious, honey-sweet fruits with jammy strawberry or amber interiors. Eaten fresh peel-on, dried into rich confectionery, or roasted.",
    "medicinalUse": "Ancient Mediterranean remedy for constipation, digestive sluggishness, respiratory coughs, and throat irritation. High in soluble fiber, calcium, magnesium, and prebiotic enzymes.",
    "recipes": "Homestead Fig & Rosemary Balsamic Jam, grilled fresh figs wrapped in prosciutto or goat cheese, and dried winter fig compote.",
  ...
  },
  {
    ...
    "commonName": "Nikita Jubilee Olive Tree",
    "latinName": "Olea europaea",
    "genus": "Olea",
    "category": "Fruit & Nut Trees",
    "categoryName": "Fruit & Nut Trees",
  ...
  },
  {
    ...
    "commonName": "Rhododendron Albert Schweitzer",
    ...
    "harvest": "Pink",
    "pests": "",
    "edibility": "NON-EDIBLE (Contains grayanotoxins; strictly ornamental and ecological). Leaves and flowers should never be ingested.",
    "medicinalUse": "Used only externally in certain folk traditions with extreme caution, but generally avoided due to diterpene toxicity.",
    "recipes": "None (non-edible species).",
  ...
  },
  {
    ...
    "commonName": "Sudachi Hybrid Yuzu",
    "latinName": "Citrus sudachi",
    "genus": "Citrus",
    "category": "Cold-Hardy Subtropicals",
    "categoryName": "Cold-Hardy Subtropicals",
    ...
    "pests": "Fertilize with citrus mix 3-4 times per year with typical applications in late winter (Jan-Feb), late spring (May-June) and early fall (Sept-Oct). Pests & Diseases: While outside, Citrus plants will likely not be bothered by insect pests. Be on the lookout for slugs.",
    "edibility": "Cold-hardy Japanese citrus fruits celebrated worldwide. Yuzu and Sudachi peel and juice offer an intoxicating, floral, complex citrus aroma prized for finishing sauces, vinegars, and ponzu.",
    "medicinalUse": "In Japanese winter solstice traditions (Toji), whole yuzu fruits are floated in hot baths to warm the body, stimulate circulation, ward off winter colds, and soothe dry skin through essential citrus oils.",
    "recipes": "Handmade Homestead Yuzu Kosho (fermented chili, yuzu zest, and salt), Sudachi ponzu vinaigrette, yuzu curd, and hot honey-yuzu tea.",
  ...
  },
  {
    ...
    "latinName": "Sambucus canadensis 'Adams'",
    "genus": "Sambucus",
    "category": "Berries & Understory",
    "categoryName": "Berries & Understory",
    "layer": "Berry Shrub Layer",
    ...
    "blooms": "Spring",
    "harvest": "",
    "pests": "Easily grown in average to enriched, moist but well-drained soil. Apply a slow release fertilizer in early spring as needed. Prune out dead or weakened stems and oldest wood in early spring. Can be cut to the ground to rejuvenate. Self-fruitful, but best fruit set when planted with a different variety of elderberry.",
    "edibility": "Cooked berries yield deeply flavorful, dark syrups, jams, and wines. Fragrant creamy-white spring flower heads are made into delicate elderflower cordials and fritters. (Raw berries must be cooked).",
    "medicinalUse": "The world's premier immune-defense berry. Clinical trials demonstrate elderberry sambucol extracts reduce the duration and severity of influenza and respiratory viruses. Elderflower tea promotes sweating during fevers.",
    "recipes": "Homestead Spiced Elderberry & Clove Syrup, Elderflower & Lemon Cordial, Elderberry Wine, and elderberry-infused honey.",
  ...
  },
  {
    ...
    "commonName": "Aronia aka Chokeberry",
    ...
    "harvest": "",
    "pests": "",
    "edibility": "Deep purple-black berries packed with one of the highest measured antioxidant concentrations (anthocyanins and polyphenols) of any temperate fruit. Strongly astringent and tart when raw, but mellows into rich berry flavor when sweetened, frozen, or cooked.",
    "medicinalUse": "Native American tribes used Aronia infusions to treat colds, sore throats, and digestive upset. Modern phytotherapy values Aronia for cardiovascular support, endothelial elasticity, and immune resilience against oxidative stress.",
    "recipes": "Spiced Aronia & Apple Homestead Jam, immune-boosting Aronia-Ginger oxymel, Aronia wine/cordial, or blended into morning smoothies to balance tartness.",
  ...
  },
  {
    ...
    "commonName": "Ashmead Kernel Apple",
    "latinName": "Malus domestica",
    "genus": "Malus",
    "category": "Fruit & Nut Trees",
    "categoryName": "Fruit & Nut Trees",
    ...
    "pests": "It is a cultivar that is susceptible to bitter pit, and fire blight",
    "edibility": "The cornerstone of the homestead orchard. Varieties range from crisp fresh-eating dessert apples to high-tannin vintage cider apples and red-fleshed antioxidant cultivars.",
    "medicinalUse": "Traditional European folk wisdom: 'An apple a day.' Rich in dietary pectin to bind cholesterol, quercetin flavonoids for allergy relief, and organic malic acid for liver health.",
    "recipes": "Homestead Hard Heritage Cider, Spiced Apple-Cider Butter, slow-baked Redlove apple tarts, and dried cinnamon apple rings.",
    "craftAndUtilitarian": "Apple wood is the premier wood for smoking bacon, sausages, and poultry. Pruned winter branches make excellent biochar and natural cooking fuel.",
  ...
  {
    "id": "blue-damson-plum",
    "commonName": "BLUE DAMSON PLUM",
    "latinName": "Prunus insititia",
    "genus": "Prunus",
    "category": "Fruit & Nut Trees",
    "categoryName": "Fruit & Nut Trees",
    "layer": "Canopy / Sub-Canopy Tree",
    ...
    "hardiness": "Hardy to minus 30°F",
    "blooms": "Bloom Time: March",
    "harvest": "September",
    "pests": "Our plums are not bothered by pests. Bacterial Canker can occasionally damage trunks or branches. Symptoms of this disease are exudations of amber-colored sap. Spraying lime-sulfur or copper in the fall and early spring can help control Bacterial Canker.",
  ...
  },
  {
    ...
    "commonName": "Baby Shipova Mt. Ash",
    "latinName": "X Sorbopyrus auricularis",
    "genus": "Sorbus",
    "category": "Fruit & Nut Trees",
    "categoryName": "Fruit & Nut Trees",
    "layer": "Sub-Canopy / Small Tree",
    ...
    "blooms": "Late spring",
    "harvest": "Early fall",
    "pests": "Baby Shipova is not bothered by pests or diseases",
    "edibility": "Selected dessert cultivars ('Rabina') produce sweet, pleasant, Vitamin C-rich berries without the bitter astringency of wild mountain ash. Eaten fresh or made into spiced jelly.",
    "medicinalUse": "Historically prized across northern Europe as a premier antiscorbutic. The sorbic acid in the berries acts as a potent natural food preservative and antifungal.",
    "recipes": "Spiced Mountain Ash Jelly with venison or roast pork, Rowan berry liqueur, and dried winter fruit tea.",
  ...
  },
  {
    ...
    "blooms": "May",
    "harvest": "September",
    "pests": "European Elderberry is not bothered by pests or diseases.",
    "edibility": "Cooked berries yield deeply flavorful, dark syrups, jams, and wines. Fragrant creamy-white spring flower heads are made into delicate elderflower cordials and fritters. (Raw berries must be cooked).",
    "medicinalUse": "The world's premier immune-defense berry. Clinical trials demonstrate elderberry sambucol extracts reduce the duration and severity of influenza and respiratory viruses. Elderflower tea promotes sweating during fevers.",
    "recipes": "Homestead Spiced Elderberry & Clove Syrup, Elderflower & Lemon Cordial, Elderberry Wine, and elderberry-infused honey.",
    "craftAndUtilitarian": "Premier natural dye: ripe berries yield gorgeous shades of lilac, purple, and blue-gray; leaves yield brilliant green. Stems have soft pith that pushes out to make flutes and spiles.",
  ...
  },
  {
    ...
    "commonName": "Black Tartarian Cherry",
    ...
    "blooms": "Early April",
    "harvest": "July",
    "pests": "Bacterial Canker can damage Cherry trees. Symptoms of bacterial canker are dead branches and bronze colored exudation on branches or trunk. Apply a fall and winter copper spray to help prevent damage from this disease.",
    "edibility": "Diverse stone fruits: sweet dessert cherries, tart pie cherries, rich European plums, sweet Japanese plums, juicy peaches, pluot hybrids, and edible sweet almonds.",
    "medicinalUse": "Cherry juice is clinically recognized for reducing gout flare-ups and exercise inflammation due to anthocyanins. Prunes provide prebiotic fiber and sorbitol for digestive health.",
    "recipes": "Homestead Italian Plum Tart, Spiced Cherry Chutney, roasted peach compote, and homemade amaretto liqueur from almond kernels.",
    "craftAndUtilitarian": "Cherry and plum timbers have exquisite reddish-brown grain prized for fine furniture, spoons, and smokehouse chips for pork and poultry.",
  ...
  },
  {
    ...
    "commonName": "Black Topaz Clove Currant",
    "latinName": "Ribes odoratum",
    "genus": "Ribes",
    "category": "Berries & Understory",
    "categoryName": "Berries & Understory",
    "layer": "Berry Shrub Layer",
    ...
    "blooms": "March-April",
    "harvest": "July",
    "pests": "Currants are not bothered by significant pest or disease problems in our region",
    "edibility": "Gooseberries and Clove Currants produce sweet, aromatic berries with a tantalizing clove fragrance or brisk vinous tartness. Eaten fresh, baked into crumbles, or jellied.",
    "medicinalUse": "Traditional European herbalists used gooseberries for fever relief and rheumatic complaints. High in dietary pectin, Vitamin C, and flavonoids.",
    "recipes": "Classic Gooseberry & Elderflower Fool, Spiced Clove Currant Jam, roasted gooseberry glaze for pork, and summer berry tarts.",
    "craftAndUtilitarian": "Thorny gooseberry bushes make protective small hedgerows; fragrant clove currant blossoms perfume the entire spring garden.",
  ...
  },
  {
    ...
    "commonName": "Blue Banana Honeyberry",
    ...
    "blooms": "March-April",
    "harvest": "May-June",
    "pests": "Pollinizer for: Borealis and most other varieties",
    "edibility": "Elongated, dusky-blue berries known as Haskap or Honeyberry. The flavor is a melting, complex combination of wild blueberry, raspberry, and blackcurrant with tender edible skin.",
    "medicinalUse": "Revered by the indigenous Ainu people of Hokkaido as the 'elixir of life'. Packed with high concentrations of cyanidin-3-glucoside (C3G) anthocyanins for ocular health and blood vessel strength.",
    "recipes": "Fresh Honeyberry Galette, Haskap-Lavender Syrup, Honeyberry & Thyme reduction over roast chicken, and frozen dessert toppings.",
  ...
  },
  {
    ...
    "blooms": "April",
    "harvest": "Late July",
    "pests": "Blueberries prefer acidic soil (pH 4.5-5.5) Fertilize in early spring with a granular or liquid acid fertilizer. In late winter prune out any dead branches. After harvest, prune non fruit-bearing branches, leaving new branches to fruit the following season.",
    "edibility": "Sweet, plump, antioxidant-packed berries. Varieties range from dwarf container types to giant northern highbush, pink rabbiteye, and native evergreen huckleberries.",
    "medicinalUse": "Celebrated for high anthocyanins, pterostilbene, and resveratrol. Clinical studies demonstrate cognitive enhancement, vascular elasticity, and urinary tract health.",
    "recipes": "Homestead Blueberry Skillet Buckle, Wild Huckleberry Tart, Blueberry Balsamic reduction, and dehydrated blueberry trail snacks.",
    "craftAndUtilitarian": "Dark berries yield soft blue-purple natural fabric dyes; evergreen huckleberry branches are prized long-lasting floristry greens.",
  ...
  },
  {
    ...
    "commonName": "Boreal Beauty Honeyberry",
    "latinName": "Lonicera caerulea",
    "genus": "Lonicera",
    "category": "Berries & Understory",
    "categoryName": "Berries & Understory",
  ...
  },
  {
    ...
    "commonName": "Braeburn Apple Tree",
    "latinName": "Malus domestica",
    "genus": "Malus",
    "category": "Fruit & Nut Trees",
    "categoryName": "Fruit & Nut Trees",
    ...
    "blooms": "April",
    "harvest": "October",
    "pests": "Braeburn can be affected by Apple Scab. Apple Scab is more prevalent in regions with wet springs, like we have in the Pacific Northwest. While it does not seriously affect the eating quality of the fruit, it can cause black spots on the apples and foliage. Apple Scab can be controlled by sulfur and other sprays. Codling Moth can create wormy apples and aphids can damage the foliage of apple trees.",
    "edibility": "The cornerstone of the homestead orchard. Varieties range from crisp fresh-eating dessert apples to high-tannin vintage cider apples and red-fleshed antioxidant cultivars.",
    "medicinalUse": "Traditional European folk wisdom: 'An apple a day.' Rich in dietary pectin to bind cholesterol, quercetin flavonoids for allergy relief, and organic malic acid for liver health.",
    "recipes": "Homestead Hard Heritage Cider, Spiced Apple-Cider Butter, slow-baked Redlove apple tarts, and dried cinnamon apple rings.",
    "craftAndUtilitarian": "Apple wood is the premier wood for smoking bacon, sausages, and poultry. Pruned winter branches make excellent biochar and natural cooking fuel.",
  ...
  },
  {
    ...
    "commonName": "Burbank Japanese Plum",
  ...
  },
  {
    ...
    "commonName": "Chang Bai Hardy Kiwi",
    ...
    "blooms": "May",
    "harvest": "Sept-Oct",
    "pests": "Hardy Kiwis are not bothered by significant pest or disease problems.",
    "edibility": "Smooth, hairless edible skin; sweet, intensely aromatic emerald flesh packed with up to 5x the Vitamin C of blackcurrants. Eaten whole directly from the vine like grapes.",
    "medicinalUse": "In traditional Asian herbal medicine (TCM as Teng Li), Actinidia fruit and roots were decocted to clear heat, reduce inflammation, improve digestion, and combat fatigue due to high ascorbic acid, potassium, and actinidain proteolytic enzymes.",
    "recipes": "Hardy Kiwi & Ginger Chutney, Kiwi-Lime Homestead Shrub, dehydrated green fruit crisps, or raw on sourdough with goat cheese and cedar honey.",
  ...
  },
  {
    ...
    "blooms": "",
    "harvest": "",
    "pests": "Gunnera is not bothered by pests or diseases.",
    "edibility": "In southern Chile (known as Nalca), the immense young leaf stalks are peeled and eaten raw with salt, tasting crisp, sour, and refreshing like wild rhubarb or celery.",
    "medicinalUse": "Mapuche medicine utilizes Gunnera root and stalk decoctions as powerful astringents and styptics to stop bleeding and relieve respiratory fevers.",
    "recipes": "Peeled Nalca stalks eaten fresh with chili-salt, or simmered into a tart compote with honey.",
  ...
  },
  {
    ...
    "commonName": "Columbia Star Thornless Blackberry",
    "latinName": "Rubus hybrid",
    "genus": "Rubus",
    "category": "Berries & Understory",
    "categoryName": "Berries & Understory",
    "layer": "Berry Shrub Layer",
    ...
    "blooms": "April",
    "harvest": "July",
    "pests": "Blackberries do not suffer from significant pest or disease problems",
    "edibility": "Large, succulent, jet-black berries bursting with sweet-tart juice. Thornless varieties allow easy, painless summer harvesting.",
    "medicinalUse": "Blackberry root and leaf tea is a classic Appalachian and Native American remedy for acute diarrhea and sore throats due to gentle astringent tannins.",
    "recipes": "Homestead Blackberry-Lavender Crisp, Blackberry Wine Reduction, cast-iron skillet cobbler, and wild blackberry cordials.",
  ...
  },
  {
    ...
    "commonName": "Comfrey aka knitbone, bruisewort",
    ...
    "harvest": "",
    "pests": "",
    "edibility": "NON-EDIBLE for food consumption (contains pyrrolizidine alkaloids; reserved for external medicinal use and soil fertility).",
    "medicinalUse": "Known for centuries as 'knitbone' and 'bruisewort'. Contains high concentrations of allantoin, a cell proliferant that rapidly accelerates the healing of sprains, broken bones, bruising, and connective tissue. Applied exclusively as external salves, oils, or poultices.",
    "recipes": "Homestead Knitbone & Arnica External Healing Salve, fermented liquid comfrey fertilizer tea.",
  ...
  },
  {
    ...
    "commonName": "Compact Stella Cherry",
    "latinName": "Prunus avium",
    "genus": "Prunus",
    "category": "Fruit & Nut Trees",
    "categoryName": "Fruit & Nut Trees",
  ...
  },
  {
    ...
    "latinName": "Malus domestica 'WA 38'",
    "genus": "Malus",
    "category": "Fruit & Nut Trees",
    "categoryName": "Fruit & Nut Trees",
    "layer": "Canopy Fruit Tree",
    ...
    "hardiness": "Zone 8b Hardy (PNW)",
    "blooms": ": Blooms 5 to 7 days after cv Gala and cv Red Delicious; bloom period shorter than Red Delicious",
    "harvest": "Late September to early October harvest",
    "pests": "",
    "edibility": "The cornerstone of the homestead orchard. Varieties range from crisp fresh-eating dessert apples to high-tannin vintage cider apples and red-fleshed antioxidant cultivars.",
    "medicinalUse": "Traditional European folk wisdom: 'An apple a day.' Rich in dietary pectin to bind cholesterol, quercetin flavonoids for allergy relief, and organic malic acid for liver health.",
    "recipes": "Homestead Hard Heritage Cider, Spiced Apple-Cider Butter, slow-baked Redlove apple tarts, and dried cinnamon apple rings.",
  ...
  },
  {
    ...
    "blooms": "May",
    "harvest": "September",
    "pests": "Evergreen Huck is not bothered by pests or disease",
    "edibility": "Sweet, plump, antioxidant-packed berries. Varieties range from dwarf container types to giant northern highbush, pink rabbiteye, and native evergreen huckleberries.",
    "medicinalUse": "Celebrated for high anthocyanins, pterostilbene, and resveratrol. Clinical studies demonstrate cognitive enhancement, vascular elasticity, and urinary tract health.",
    "recipes": "Homestead Blueberry Skillet Buckle, Wild Huckleberry Tart, Blueberry Balsamic reduction, and dehydrated blueberry trail snacks.",
    "craftAndUtilitarian": "Dark berries yield soft blue-purple natural fabric dyes; evergreen huckleberry branches are prized long-lasting floristry greens.",
  ...
  },
  {
    ...
    "hardiness": "Zone 8b Hardy (PNW)",
    "blooms": "",
    "harvest": "For fresh-cut flowers: Harvest in the morning when flowers are their freshest and petals are just opening • Cut with a clean knife that has been dipped in a solution of 10% household bleach • A few drops of bleach in the vase will prolong their beauty",
    "pests": "Early watering and good weed control will generally alleviate most problems Pyrethrin will control most insects",
    "edibility": "Nutty, slate-blue poppy seeds are widely used in baking, breads, strudels, and dressings. Cold-pressed poppy seed oil is a delicate culinary oil.",
    "medicinalUse": "Historically the foundation of human pain medicine. Traditional folk herbalism used mild dried poppy seed pod decoctions as a gentle sedative and cough syrup.",
    "recipes": "Homestead Lemon Poppy Seed Scones, savory poppy seed crust on sourdough loaves, and toasted poppy seed dressings.",
  ...
  },
  {
    ...
    "commonName": "Flavor Queen Pluot Tree",
    "latinName": "Prunus salicina x Prunus armeniaca",
    "genus": "Prunus",
    "category": "Fruit & Nut Trees",
    "categoryName": "Fruit & Nut Trees",
    "layer": "Canopy / Sub-Canopy Tree",
    ...
    "size": "12-18 ft. in height.",
    "hardiness": "Flavor Queen is hardy to at least minus 20° F.",
    "blooms": "Early March-April",
    "harvest": "Late July",
    "pests": "Our pluots are not bothered by pests aside from the occasional aphids. Bacterial Canker can occasionally damage trunks or branches. Symptoms of this disease are exudations of amber-colored sap. Spraying lime-sulfur or copper in the fall and early spring can help control Bacterial Canker. Brown rot can affect fruits in particularly wet springs or areas with poor air flow.",
    "edibility": "Diverse stone fruits: sweet dessert cherries, tart pie cherries, rich European plums, sweet Japanese plums, juicy peaches, pluot hybrids, and edible sweet almonds.",
    "medicinalUse": "Cherry juice is clinically recognized for reducing gout flare-ups and exercise inflammation due to anthocyanins. Prunes provide prebiotic fiber and sorbitol for digestive health.",
    "recipes": "Homestead Italian Plum Tart, Spiced Cherry Chutney, roasted peach compote, and homemade amaretto liqueur from almond kernels.",
    "craftAndUtilitarian": "Cherry and plum timbers have exquisite reddish-brown grain prized for fine furniture, spoons, and smokehouse chips for pork and poultry.",
  ...
  },
  {
    ...
    "commonName": "Flying Dragon Citrus",
    "latinName": "Poncirus trifoliata monstrosa",
    "genus": "Poncirus",
    "category": "Cold-Hardy Subtropicals",
    "categoryName": "Cold-Hardy Subtropicals",
    "layer": "Subtropical Microclimate Layer",
    ...
    "harvest": "Late fall",
    "pests": "Fertilize with citrus mix 3-4 times per year with typical applications in late winter (Jan-Feb), late spring (May-June) and early fall (Sept-Oct). Pests & Diseases: While outside, Citrus plants will likely not be bothered by insect pests. Be on the lookout for slugs.",
    "edibility": "The cold-hardiest citrus on Earth (survives -20°F). The small, fuzzy fruits have a high resin content and intense sour acidity; the juice and zest make zesty marmalades and citrus marinades.",
    "medicinalUse": "In Traditional Chinese Medicine (Zhi Ke / Gou Ju), dried immature fruits are prescribed to break up phlegm, stimulate gastrointestinal peristalsis, and ease abdominal distension.",
    "recipes": "Flying Dragon Homestead Marmalade, spicy sour citrus ponzu glaze, and citrus-infused salt.",
  ...
  },
  {
    ...
    "commonName": "GIANT TIMBER BAMBOO",
    "latinName": "Phyllostachys vivax",
    "genus": "Phyllostachys",
    "category": "Soil Builders & Craft Allies",
    "categoryName": "Soil Builders & Craft",
    ...
    "harvest": "",
    "pests": "",
    "edibility": "Tender young spring shoots emerging from the ground are harvested, peeled, and boiled to yield crisp, sweet, nutritious vegetable shoots prized in Asian cuisine.",
    "medicinalUse": "Bamboo leaf and shoot decoctions in Traditional Chinese Medicine (Zhu Ye) clear heat, relieve phlegm, and provide bio-available silica for bone and connective tissue health.",
    "recipes": "Braised Spring Bamboo Shoots with soy and sesame, stir-fried shoots with greens, and pickled winter bamboo slices.",
  ...
  },
  {
    ...
    "commonName": "Giant's Heart Honeyberry",
    "latinName": "Lonicera caerulea var. emphyllocalyx",
    "genus": "Lonicera",
    "category": "Berries & Understory",
    "categoryName": "Berries & Understory",
    "layer": "Early Shrub Layer",
    ...
    "blooms": "March",
    "harvest": "June",
    "pests": "Honeyberry is not bothered by pests or diseases. To deter birds, use mylar flash tape or cover plants",
    "edibility": "Elongated, dusky-blue berries known as Haskap or Honeyberry. The flavor is a melting, complex combination of wild blueberry, raspberry, and blackcurrant with tender edible skin.",
    "medicinalUse": "Revered by the indigenous Ainu people of Hokkaido as the 'elixir of life'. Packed with high concentrations of cyanidin-3-glucoside (C3G) anthocyanins for ocular health and blood vessel strength.",
    "recipes": "Fresh Honeyberry Galette, Haskap-Lavender Syrup, Honeyberry & Thyme reduction over roast chicken, and frozen dessert toppings.",
    "craftAndUtilitarian": "Extreme cold hardiness: flowers tolerate -7°C (20°F) frost in full bloom without damage. Early spring forage for bumblebees.",
  ...
  },
  {
    ...
    "commonName": "Golden Silverberry",
    "latinName": "Elaeagnus pungens 'Hosoba Fukurin'",
    "genus": "Elaeagnus",
    "category": "Soil Builders & Craft Allies",
    "categoryName": "Soil Builders & Craft",
    "layer": "Shrub Layer",
    ...
    "blooms": "Late fall",
    "harvest": "Spring",
    "pests": "Silverberry is not bothered by pests or diseases.",
    "edibility": "Produces small, red, silver-speckled drupes in spring with a pleasant sweet-tart flavor rich in lycopene and essential fatty acids.",
    "medicinalUse": "In traditional Asian herbalism, the fruits, leaves, and roots were used for respiratory coughs, digestive comfort, and rheumatic joints.",
    "recipes": "Small-batch Silverberry cordial, fresh wild trail snack, or fruit reduction syrup.",
  ...
  },
  {
    ...
    "commonName": "Golden Sweet Sea Berry",
    "latinName": "Hippophae rhamnoides",
    "genus": "Hippophae",
    "category": "Berries & Understory",
    "categoryName": "Berries & Understory",
  ...
  {
    "id": "havard-agave",
    "commonName": "Havard Agave",
    "latinName": "Agave havardiana",
    "genus": "Agave",
    "category": "Cold-Hardy Subtropicals",
    "categoryName": "Cold-Hardy Subtropicals",
    "layer": "Microclimate Succulent",
    ...
    "blooms": "Early spring through summer every 10-20 years or so",
    "harvest": "",
    "pests": "",
    "edibility": "Roasted agave hearts ('piña') were traditionally pit-baked for 48-72 hours by indigenous peoples of the American Southwest and Northern Mexico, yielding a caramelized, molasses-sweet food rich in prebiotic inulin. Sap (aguamiel) can be fermented into pulque.",
    "medicinalUse": "Historically used as an antimicrobial dressing for wounds and burns. The fresh sap contains saponins and fructans with mild antiseptic and soothing qualities; poulticed leaves were used for joint aches.",
  ...
  },
  {
    ...
    "commonName": "Hinnomaki Red Gooseberry",
    ...
    "blooms": "April",
    "harvest": "July",
    "pests": "Our varieties are resistant to Powdery Mildew, the most common disease of Gooseberries. Currant Worm feeds on the foliage and is the same color. It can easily be removed by hand.",
    "edibility": "Gooseberries and Clove Currants produce sweet, aromatic berries with a tantalizing clove fragrance or brisk vinous tartness. Eaten fresh, baked into crumbles, or jellied.",
    "medicinalUse": "Traditional European herbalists used gooseberries for fever relief and rheumatic complaints. High in dietary pectin, Vitamin C, and flavonoids.",
    "recipes": "Classic Gooseberry & Elderflower Fool, Spiced Clove Currant Jam, roasted gooseberry glaze for pork, and summer berry tarts.",
    "craftAndUtilitarian": "Thorny gooseberry bushes make protective small hedgerows; fragrant clove currant blossoms perfume the entire spring garden.",
  ...
  },
  {
    ...
    "commonName": "Honeyberry Maxine's Opus",
    "latinName": "Lonicera caerulea",
    "genus": "Lonicera",
    "category": "Berries & Understory",
    "categoryName": "Berries & Understory",
  ...
  {
    "id": "hopin-alba-oca",
    "commonName": "Hopin Alba Oca",
    "latinName": "Oxalis tuberosum",
    "genus": "Oxalis",
    "category": "Perennial Vegetables & Roots",
    ...
    "harvest": "",
    "pests": "",
    "edibility": "Ancient Andean tuber crop (Oca). Eaten raw, tubers are crisp, juicy, and lemony. When roasted or boiled, the oxalic acid diminishes, transforming them into tender, sweet, nutty delicacies.",
    "medicinalUse": "High in Vitamin C, potassium, and iron. Andean communities sun-cure oca (a process called 'soleado') to increase sugars and reduce acidity for easy digestion.",
    "recipes": "Cast-Iron Roasted Oca with Homestead Rosemary and Garlic, Oca & Leek Autumn Chowder, and thinly sliced raw oca salad with lime.",
  ...
  {
    "id": "italian-plum",
    "commonName": "ITALIAN PLUM",
    "latinName": "Prunus x domestica",
    "genus": "Prunus",
    "category": "Fruit & Nut Trees",
    "categoryName": "Fruit & Nut Trees",
    "layer": "Canopy / Sub-Canopy Tree",
  ...
  },
  {
    ...
    "commonName": "Illinois Everbearing Mulberry",
    "latinName": "Morus alba x rubra",
    "genus": "Morus",
    "category": "Fruit & Nut Trees",
    "categoryName": "Fruit & Nut Trees",
    "layer": "Canopy / Sub-Canopy Tree",
    ...
    "blooms": "Spring",
    "harvest": "July-Sept",
    "pests": "Mulberries are not bothered by pests or diseases.",
    "edibility": "Prodigious yields of elongated, juicy, blackberry-like fruits with a rich, honeyed, sweet-tart flavor without seeds. Continuous harvest for months.",
    "medicinalUse": "In Chinese medicine (Sang Shen), mulberries nourish yin and blood, support kidney function, and treat premature graying. Mulberry leaf tea (Sang Ye) regulates blood sugar levels.",
    "recipes": "Fresh Mulberry Galette, Mulberry-Vanilla Preserves, mulberry pancakes, and homestead mulberry wine.",
  ...
  },
  {
    ...
    "pests": "",
    "edibility": "The source of all authentic tea. Tender young top flushes (bud and first two leaves) are harvested in spring for homemade green, oolong, or black tea depending on oxidation.",
    "medicinalUse": "Centuries of traditional East Asian medicine revere Camellia sinensis for mental clarity, longevity, cardiovascular health, and metabolic stimulation, powered by L-theanine and EGCG catechins.",
    "recipes": "Homestead pan-fired Spring Green Tea, cold-brewed summer green tea with mint, and culinary matcha-infused shortbread.",
  ...
  },
  {
    ...
    "harvest": "",
    "pests": "",
    "edibility": "Tender white base and lower stalks provide an intensely citrusy, floral, aromatic brightness central to Southeast Asian cuisine, broths, and curries.",
    "medicinalUse": "Traditional herbal tea for fever relief, digestion, and anxiety relief. Contains citral and limonene with proven antimicrobial, antifungal, and calming properties.",
    "recipes": "Homestead Lemongrass-Ginger Chicken broth, hot lemongrass & mint iced tea, and Thai green curry paste.",
  ...
  {
    "id": "muir-peach",
    "commonName": "MUIR PEACH",
    "latinName": "Prunus persica 'Muir'",
    "genus": "Prunus",
    "category": "Fruit & Nut Trees",
    "categoryName": "Fruit & Nut Trees",
    "layer": "Canopy / Sub-Canopy Tree",
  ...
  },
  {
    ...
    "blooms": "May-June",
    "harvest": "October",
    "pests": "Olive Trees will occasionally get scales and in some climates are susceptible to Cercospora leaf spot",
    "edibility": "Cold-hardy olive cultivars selected for northern climates. Bitter raw fruits are water-cured, lye-cured, or brined with herbs into delicious table olives, or cold-pressed for extra-virgin oil.",
    "medicinalUse": "Olive oil is the foundation of the heart-healthy Mediterranean diet. Olive leaf extract contains oleuropein, a documented natural antiviral, antibacterial, and hypotensive agent.",
    "recipes": "Homestead Rosemary & Garlic Brined Olives, cold-pressed olive oil, and olive tapenade with capers and lemon.",
    "craftAndUtilitarian": "Olive leaves produce gentle herbal teas. Pruned olive wood has dense, swirling grain prized for artisanal cutting boards, spoons, and carving.",
  ...
  },
  {
    ...
    "commonName": "Missouri Giant Clove Currant",
    "latinName": "Ribes odoratum",
    "genus": "Ribes",
    "category": "Berries & Understory",
    "categoryName": "Berries & Understory",
    ...
    "blooms": "March-April",
    "harvest": "July",
    "pests": "Currants are not bothered by significant pest or disease problems in our region. White Pine Blister Rust can be a problem for Black Currants in certain eastern and Midwestern states",
    "edibility": "Gooseberries and Clove Currants produce sweet, aromatic berries with a tantalizing clove fragrance or brisk vinous tartness. Eaten fresh, baked into crumbles, or jellied.",
    "medicinalUse": "Traditional European herbalists used gooseberries for fever relief and rheumatic complaints. High in dietary pectin, Vitamin C, and flavonoids.",
    "recipes": "Classic Gooseberry & Elderflower Fool, Spiced Clove Currant Jam, roasted gooseberry glaze for pork, and summer berry tarts.",
    "craftAndUtilitarian": "Thorny gooseberry bushes make protective small hedgerows; fragrant clove currant blossoms perfume the entire spring garden.",
  ...
  },
  {
    ...
    "hardiness": "Hardiness: Hardy to minus 40° F.",
    "blooms": "April",
    "harvest": "September",
    "pests": "Aronia is not bothered by pests or diseases.",
    "edibility": "Deep purple-black berries packed with one of the highest measured antioxidant concentrations (anthocyanins and polyphenols) of any temperate fruit. Strongly astringent and tart when raw, but mellows into rich berry flavor when sweetened, frozen, or cooked.",
    "medicinalUse": "Native American tribes used Aronia infusions to treat colds, sore throats, and digestive upset. Modern phytotherapy values Aronia for cardiovascular support, endothelial elasticity, and immune resilience against oxidative stress.",
    "recipes": "Spiced Aronia & Apple Homestead Jam, immune-boosting Aronia-Ginger oxymel, Aronia wine/cordial, or blended into morning smoothies to balance tartness.",
    "craftAndUtilitarian": "The deep pigments yield rich purple, mauve, and soft slate-gray natural dyes for wool and raw linen fibers. Sturdy upright canes create excellent wildlife hedgerows.",
  ...
  },
  {
    ...
    "commonName": "Nikita Pineapple Guava",
    "latinName": "Feijoa sellowiana",
    "genus": "Feijoa",
    "category": "Fruit & Nut Trees",
    "categoryName": "Cold-Hardy Subtropicals",
    "layer": "Canopy Fruit Tree",
    ...
    "blooms": "July",
    "harvest": "November",
    "pests": "Pineapple Guava is not bothered by pests or diseases.",
    "edibility": "Intensely aromatic fruit with translucent, jelly-like pulp tasting of pineapple, spearmint, guava, and strawberry. The thick, fleshy, crimson-and-white spring flower petals are also edible, tasting like sweet spun sugar and cinnamon.",
    "medicinalUse": "High in dietary fiber, iodine, potassium, and Vitamin C. Traditionally valued in South American herbalism for thyroid support and digestive regularity.",
    "recipes": "Pineapple Guava Spoon Jam, Feijoa Chutney with homestead apples, dehydrated feijoa chips, and fresh flower petal salads.",
  ...
  },
  {
    ...
    "commonName": "ORANGE GLOW SIBERIAN SEABERRY",
    "latinName": "Hippophae rhamnoides",
    "genus": "Hippophae",
    "category": "Berries & Understory",
    "categoryName": "Berries & Understory",
  ...
  },
  {
    ...
    "commonName": "Orange Glow Sea Berry",
    "latinName": "Hippophae rhamnoides",
    "genus": "Hippophae",
    "category": "Berries & Understory",
    "categoryName": "Berries & Understory",
  ...
  },
  {
    ...
    "blooms": "Early spring",
    "harvest": "Late summer",
    "pests": "This Plant is not bothered by pests or diseases",
    "edibility": "Dusty-blue clusters of berries with a sharp, tart, mouth-puckering flavor. Best sweetened into pies, jellies, or mixed with sweeter wild fruits.",
    "medicinalUse": "Famous herbal bitter. Bright yellow roots and inner stems are packed with berberine, a potent broad-spectrum antimicrobial, liver stimulant, and digestive toner used widely in Native American and Western herbalism.",
    "recipes": "Oregon Grape & Apple Jelly, wild mountain spiced cordial, and digestive herbal bitter tonic.",
  ...
  },
  {
    ...
    "commonName": "Perpetua Olive Tree",
    "latinName": "Olea europaea",
    "genus": "Olea",
    "category": "Fruit & Nut Trees",
    "categoryName": "Fruit & Nut Trees",
  ...
  },
  {
    ...
    "commonName": "Prolific Pawpaw Tree",
    "latinName": "Asimina triloba",
    "genus": "Asimina",
    "category": "Fruit & Nut Trees",
    "categoryName": "Fruit & Nut Trees",
  ...
  },
  {
    ...
    "commonName": "Rabbiteye Blueberry Florida Rose",
    "latinName": "Vaccinium ashei",
    "genus": "Vaccinium",
    "category": "Berries & Understory",
    "categoryName": "Berries & Understory",
    "layer": "Berry Shrub Layer",
  ...
  },
  {
    ...
    "blooms": "Late spring",
    "harvest": "Early Fall",
    "pests": "Rabina is not bothered by pests or diseases.",
    "edibility": "Selected dessert cultivars ('Rabina') produce sweet, pleasant, Vitamin C-rich berries without the bitter astringency of wild mountain ash. Eaten fresh or made into spiced jelly.",
    "medicinalUse": "Historically prized across northern Europe as a premier antiscorbutic. The sorbic acid in the berries acts as a potent natural food preservative and antifungal.",
    "recipes": "Spiced Mountain Ash Jelly with venison or roast pork, Rowan berry liqueur, and dried winter fruit tea.",
    "craftAndUtilitarian": "Hard, close-grained wood historically used for tool handles, spinning wheels, and woodcarving; berries yield orange-salmon dyes.",
  ...
  },
  {
    ...
    "commonName": "Ranch American Elderberry",
    ...
    "blooms": "June",
    "harvest": "September",
    "pests": "Elderberries are not bothered by pests or diseases",
    "edibility": "Cooked berries yield deeply flavorful, dark syrups, jams, and wines. Fragrant creamy-white spring flower heads are made into delicate elderflower cordials and fritters. (Raw berries must be cooked).",
    "medicinalUse": "The world's premier immune-defense berry. Clinical trials demonstrate elderberry sambucol extracts reduce the duration and severity of influenza and respiratory viruses. Elderflower tea promotes sweating during fevers.",
    "recipes": "Homestead Spiced Elderberry & Clove Syrup, Elderflower & Lemon Cordial, Elderberry Wine, and elderberry-infused honey.",
    "craftAndUtilitarian": "Premier natural dye: ripe berries yield gorgeous shades of lilac, purple, and blue-gray; leaves yield brilliant green. Stems have soft pith that pushes out to make flutes and spiles.",
  ...
  },
  {
    ...
    "commonName": "Red Star Cornelian Cherry",
    ...
    "pests": "No pest problems have been observed on our Cornelian Cherry plants. Dogwood Anthracnose can cause black spots to appear on the leaves of some varieties during wet springs. Once the rainy weather stops, the new leaves are not affected. A copper spray in the spring and early summer should help control it.",
    "edibility": "Cornelian cherries are ancient European stone fruits. When fully ripe and deep garnet-red (or translucent gold), they have a delicious, brisk sweet-tart flavor reminiscent of a cross between sour cherry, plum, and cranberry.",
    "medicinalUse": "Prescribed in ancient Greek, Roman, and Persian medicine to treat gastrointestinal ailments, diarrhea, fevers, and kidney stones due to powerful astringency, high pectin, and Vitamin C.",
    "recipes": "Traditional Cornelian Cherry Jam ('Drenjine'), spiced meat sauce glaze for roasted fowl, fermented cornelian cherry wine, or dried like tart raisins.",
  ...
  },
  {
    ...
    "commonName": "Salal Evergreen Shrub",
    "latinName": "Gaultheria shallon",
    "genus": "Gaultheria",
    "category": "Berries & Understory",
    "categoryName": "Native Berries & Understory",
    "layer": "Berry Shrub Layer",
    ...
    "blooms": "Spring",
    "harvest": "September",
    "pests": "This Northwest native is not bothered by pests or diseases",
    "edibility": "Deep purple-black native berries with a sweet, rich, slightly earthy flavor. Highly revered by PNW Coastal Salish peoples as a foundational staple food.",
    "medicinalUse": "Indigenous PNW peoples brewed salal leaf teas for stomach trouble, coughs, bladder infections, and applied chewed leaves directly to bee stings, cuts, and burns for rapid soothing.",
    "recipes": "Traditional Salal Berry Jam, Salal & Blackberry wild fruit leather, and salal syrup over sourdough pancakes.",
  ...
  {
    "id": "samyl-elderberry",
    "commonName": "Samyl Elderberry",
    "latinName": "Sambucus nigra 'Samdyl'",
    "genus": "Sambucus",
    "category": "Berries & Understory",
    "categoryName": "Berries & Understory",
    "layer": "Berry Shrub Layer",
  ...
  },
  {
    ...
    "harvest": "",
    "pests": "",
    "edibility": "A prized coastal European perennial vegetable. In early spring, blanched pale shoots are harvested and steamed, offering a sweet, delicate flavor superior to asparagus or broccoli. Young leaves and florets are delicious sautéed.",
    "medicinalUse": "Historically consumed by sailors and coastal villagers as a potent antiscorbutic to prevent scurvy due to high ascorbic acid and glucosinolates with antioxidant properties.",
    "recipes": "Blanched Sea Kale Shoots with browned butter and lemon, stir-fried sea kale florets with garlic, and pickled crunchy stems.",
  ...
  },
  {
    ...
    "size": "6-8″ in height.",
    "hardiness": "Seascape is hardy to 0° F.",
    "blooms": "March – late summer",
    "harvest": "June-October",
    "pests": "Strawberries are not bothered by insect pests or diseases. Use straw mulch to keep berries off of soil and to deter slugs.",
    "edibility": "Sweet, fragrant, ruby-red berries harvested continuously from late spring through the first autumn frosts. Classic table fruit.",
    "medicinalUse": "Strawberry leaf tea is an old European and Native American folk remedy for diarrhea, mild diuretic cleansing, and soothing mouth ulcers due to mild tannins and Vitamin C.",
    "recipes": "Classic Homestead Strawberry Jam, fresh strawberry-mint shrub, and rustic cast-iron strawberry cobbler.",
  ...
  },
  {
    ...
    "commonName": "Seaside Almond Tree",
    "latinName": "Prunus dulcis",
    "genus": "Prunus",
    "category": "Fruit & Nut Trees",
    "categoryName": "Fruit & Nut Trees",
  ...
  },
  {
    ...
    "commonName": "Siberian Splendor Sea Berry",
    "latinName": "Hippophae rhamnoides",
    "genus": "Hippophae",
    "category": "Berries & Understory",
    "categoryName": "Berries & Understory",
  ...
  },
  {
    ...
    "blooms": "June",
    "harvest": "October",
    "pests": "Sudden Oak Death can be an issue for Quercus species in Southwest Oregon and California but so far we have not seen it affecting oaks in the Portland Metro area",
    "edibility": "Inoculated with French Black Truffles (Tuber melanosporum). The tree roots form an underground symbiosis producing the most prized culinary delicacy on earth. Acorns can also be leached for acorn flour.",
    "medicinalUse": "Oak bark has been utilized in European herbal medicine for millennia as a potent astringent wash for wounds, gum inflammation, and skin irritations due to high oak tannins.",
    "recipes": "Black Truffle infused homestead butter, shaved fresh truffle over farm eggs and pasta, and leached acorn flour pancakes.",
  ...
  },
  {
    ...
    "hardiness": "Hardy to minus 40° F.",
    "blooms": "April",
    "harvest": "Ripening Time: September",
    "pests": "Aronia is not bothered by pests or diseases",
    "edibility": "Deep purple-black berries packed with one of the highest measured antioxidant concentrations (anthocyanins and polyphenols) of any temperate fruit. Strongly astringent and tart when raw, but mellows into rich berry flavor when sweetened, frozen, or cooked.",
    "medicinalUse": "Native American tribes used Aronia infusions to treat colds, sore throats, and digestive upset. Modern phytotherapy values Aronia for cardiovascular support, endothelial elasticity, and immune resilience against oxidative stress.",
    "recipes": "Spiced Aronia & Apple Homestead Jam, immune-boosting Aronia-Ginger oxymel, Aronia wine/cordial, or blended into morning smoothies to balance tartness.",
  ...
  },
  {
    ...
    "blooms": "Flowers are not noticeable as they are inside the fig.",
    "harvest": "Sept-Nov",
    "pests": "Figs are not bothered by pests in our region. Cover plants with netting if birds are a problem. Fig Mosaic Virus is a benign virus that exists in all cultivated fig trees. Yellow spotting of the leaves is a cosmetic symptom",
    "edibility": "Rich, luscious, honey-sweet fruits with jammy strawberry or amber interiors. Eaten fresh peel-on, dried into rich confectionery, or roasted.",
    "medicinalUse": "Ancient Mediterranean remedy for constipation, digestive sluggishness, respiratory coughs, and throat irritation. High in soluble fiber, calcium, magnesium, and prebiotic enzymes.",
    "recipes": "Homestead Fig & Rosemary Balsamic Jam, grilled fresh figs wrapped in prosciutto or goat cheese, and dried winter fig compote.",
    "craftAndUtilitarian": "Fig leaf tea has a delicate coconut-vanilla aroma. Fig leaves wrapped around cheeses or fish provide aromatics and natural food preservation.",
  ...
  },
  {
    ...
    "commonName": "Yellow Cornelian Cherry Tree",
    "latinName": "Cornus mas",
    "genus": "Cornus",
    "category": "Fruit & Nut Trees",
    "categoryName": "Fruit & Nut Trees",
  ...
  },
  {
    ...
    "commonName": "Yuzu Ichandrin Hardy Citrus",
    ...
    "size": "4-6 ft",
    "hardiness": "Yuzu Ichandrin can be grown outdoors in regions with mild winters. It likes 1/2 day to full sun and well drained soil.",
    "blooms": "Spring",
    "harvest": "Late fall to winter.",
    "pests": "While outside, Citrus plants will likely not be bothered by insect pests. Be on the lookout for slugs. Indoors, Citrus can have mites and/or aphids. Watch carefully for any problems and treat with an insecticidal soap or wash them off",
    "edibility": "Cold-hardy Japanese citrus fruits celebrated worldwide. Yuzu and Sudachi peel and juice offer an intoxicating, floral, complex citrus aroma prized for finishing sauces, vinegars, and ponzu.",
    "medicinalUse": "In Japanese winter solstice traditions (Toji), whole yuzu fruits are floated in hot baths to warm the body, stimulate circulation, ward off winter colds, and soothe dry skin through essential citrus oils.",
    "recipes": "Handmade Homestead Yuzu Kosho (fermented chili, yuzu zest, and salt), Sudachi ponzu vinaigrette, yuzu curd, and hot honey-yuzu tea.",
    "craftAndUtilitarian": "Citrus essential oils in the peel have potent natural degreasing, antimicrobial, and aromatic properties for homestead soaps, salves, and potpourri.",
